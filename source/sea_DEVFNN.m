...
covariance_old=covariance;
    ...
    groundtruth=zeros(size(Data,1),1);
...
%              factor=0;
%                  for i=1:ensemble
%                      factor=factor+network(i).voting_weight;
%                  end
%             for i=1:ensemble
%                 network(i).voting_weight=network(i).voting_weight/factor;
